 ...
 * @author thean
 */
@WebServlet(name = "RejectCV", urlPatterns = {"/RejectCV"})
public class RejectCV extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RejectCV</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet RejectCV at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        EmailUtil.SendEmailRejectCV(acc);
