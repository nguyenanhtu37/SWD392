...
public class ViewCVSentUser extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<CV> CVListSent = CVDB.getListCVfromUserID(userID);
        request.setAttribute("CVListSent", CVListSent);
        request.getRequestDispatcher("ViewCVSentUser.jsp").forward(request, response);
    }
