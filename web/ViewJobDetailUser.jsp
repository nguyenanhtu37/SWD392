        ...
        <div class="site-wrap">
            ...
            <section class="section-hero overlay inner-page bg-image" style="background-image: url('images/hero_1.jpg');"
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            <h1 class="text-white font-weight-bold">Job Detail users</h1>
            ...
            <section class="site-section">
                ...
                <div class="container">
                    ...
                    <div class="row mb-5">
                        <div class="col-lg-12">
                            <form action="PostJobServlet" class="p-4 p-md-5 border rounded" method="post">
                                <div>
                                    <h3 class="text-black mb-5 border-bottom pb-2 text-capitalize d-flex justify-content-between align-items-center">Job
                                        <button id="reportButton" type="button" class="btn btn-primary" style="background: red"><i class="fa-solid fa-triangle-exclamation" style="background: red" id="reportBt"></i></button>
                                    </h3>
                                </div>
                    ...
                    <!--===================Comment======================================-->                                
                    <form id="commet_tag" class="row mb-5" method="post" action="comment">
                        ...
                        <div class="col-1" id="divComment">
                            ...
                            <input type="hidden" value="${User.userID}" name="idU">
                    ...
                    <!--===========report=============--> 
                    <form action="enterSendRe" method="post">
            ...
            <li class="list-group-item">
                                    <div class="row">
                                        ...
                                        <div >
                                            <c:if test="${User.userID eq x.userId}">
                                                <div class="d-flex justify-content-end">
                                                    <form class="col-11 d-flex" style="height: 100%" action="updateComment" method="post">
                    ...
                    <div class="order-last">
                             ...
                             <button type="button" id="editButton${x.idC}" class="btn btn-primary" onclick="enableEdit(${x.idC})"><i class="fa-regular fa-pen-to-square"></i></button>   
                                                                    ...
                                                                    <form class="col-1" action="delete" method="post" onsubmit="return confirmDelete()">
<!--==============Delete comment ===========-->   
                                                                <input type="hidden" value="${JobDetail.jobId}" name="jobid">
                                                                <input type="hidden" value="${x.idC}" name="idC">
