<%-- 
    Document   : ViewCVSentUser
    Created on : Nov 8, 2023, 5:56:21 PM
    Author     : thean
--%>
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<jsp:useBean id="CVListJobSent" class="java.util.ArrayList" scope="session" />
<!doctype html>
<html lang="en">
            ...
            <section class="home-section section-hero overlay bg-image" style="background-image: url('images/hero_1.jpg'); "
                ...
                <div class="container scroll" style="overflow-y:scroll;">
                    <div class="row justify-content-center">
                        ...
                        <c:forEach items="${CVListJobSent}" var="cv">
                            <c:if test="${cv.getIsAccept() ne 'Reject'}">

                            <div class="col-md-12 align-items-start">
                                <div class="mb-5 border rounded" style="background-color: whitesmoke; color: black;">
                                    <div class="p-3  border rounded">
                                        <form action="ViewCVSentUser" class="px-3 px-md-5 py-1 py-md-3 border rounded" method="post">
                                            <a href="/SWP_JC${cv.getCVAddress()}" target="_blank" class="possion text-black mb-5 pb-2 text-capitalize" style="font-size: 50px;font-weight: bold;">${cv.getAppliTitle()}</a>
                                            <h3 class="text-black mb-2 border-bottom pb-2 text-capitalize">${cv.getJobPossion()}</h3>
                                            <div class="p-1">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="row form-group">
                                                            <label for="name" class="col-4 col-form-label text-capitalize">Job Description</label>
                                                            <div class="col-sm-8">
                                                                ${cv.getCoverLetter()}
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row align-items-center mb-1">                                                    
                                                <div class="col-lg-3">
                                                    <a href="AcceptCV?id=${cv.getCVID()}&eId=${cv.getJobID()}&cId=${cv.getUserID()}" class="btn btn-block btn-primary btn-md">Accept</a>
                                                </div>
                                                <div class="col-lg-3">
                                                    <a href="RejectCV?id=${cv.getCVID()}&eId=${cv.getJobID()}&cId=${cv.getUserID()}" class="btn btn-block btn-danger btn-md">Reject</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
