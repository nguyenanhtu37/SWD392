...
<jsp:useBean id="CVListSent" class="java.util.ArrayList" scope="session" />
<!doctype html>
<html lang="en">
            ...
            <section class="home-section section-hero overlay bg-image" style="background-image: url('images/hero_1.jpg'); "
                ...
                <div class="container scroll" style="overflow-y:scroll;">
                    <div class="row justify-content-center">
                        ...
                        <c:forEach items="${CVListSent}" var="cv">
                                ...
                                <div class="mb-5 border rounded" style="background-color: whitesmoke; color: black;">
                                    <div class="p-3  border rounded">
                                        <form action="ViewCVSentUser" class="px-3 px-md-5 py-1 py-md-3 border rounded" method="post">
                                            <a href="/SWP_JC${cv.getCVAddress()}" target="_blank" class="possion text-black mb-5 pb-2 text-capitalize" style="font-size: 50px;font-weight: bold;">${cv.getCVID()} You apply for: ${cv.getJobTitle()}</a>
                                            <h3 class="text-black mb-2 border-bottom pb-2 text-capitalize">${cv.getJobSalary()}</h3>
                                            <div class="p-1">
                                                <div class="row">
                                                    <div class="col-md-4">
